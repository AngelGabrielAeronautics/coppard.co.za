...
export default function SculptedFigurePage() {
  ...
  const painting = {
    ...
    description:
      "An elegant nude study that captures the graceful lines and subtle contours of the female form. The figure is depicted standing with her face turned away, creating a sense of both intimacy and anonymity. Rendered in soft, warm flesh tones against a neutral pale background, the painting emphasizes the sculptural quality of the human body through careful attention to light, shadow, and form. The minimalist approach and delicate brushwork create a sense of timeless beauty and quiet dignity.",
    year: "2023",
    ...
    additionalImages: ["/images/sculpted-figure.jpeg"],
    details:
    ...
    <div className="container px-4 py-12 mx-auto md:px-6 md:py-16">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:gap-12">
        ...
        <div className="space-y-4">
          <div className="overflow-hidden rounded-lg bg-neutral-100" style={{ minHeight: "600px" }}>
            <Image
