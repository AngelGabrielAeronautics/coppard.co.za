...
export default function MirrorLakePage() {
  ...
  const painting = {
    ...
    description:
      "A serene landscape capturing the magical moment of sunset over a perfectly still lake. The composition features a small blue rowboat in the foreground, with wooden mooring posts to the right, all set against a spectacular golden sky that's mirrored in the calm waters below. The painting masterfully captures the tranquil atmosphere and warm glow of the setting sun, with rich oranges and yellows transitioning to cooler blues in the water. The perfect reflection creates a sense of symmetry and peaceful balance.",
    year: "2023",
    ...
    additionalImages: ["/images/mirror-lake.jpeg"],
    details:
