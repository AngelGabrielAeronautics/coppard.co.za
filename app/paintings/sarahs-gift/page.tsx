...
export default function SarahsGiftPage() {
  ...
  const painting = {
    ...
    title: "Sarah's Gift",
    description:
      "An intimate and delicate nude study rendered in soft, muted tones. This painting captures the gentle curves and subtle coloration of the human form with sensitivity and artistic restraint. The composition focuses on form and light, creating a work that is both personal and universal in its celebration of natural beauty. The painting's soft focus and warm palette create a dreamlike quality that invites contemplation.",
    year: "2023",
    ...
    additionalImages: ["/images/sarahs-gift.jpeg"],
    details:
