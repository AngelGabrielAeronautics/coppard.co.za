...
export default function BlueWaxbillPage() {
  ...
  const painting = {
    ...
    title: "Blue Waxbill",
    description:
      "A delicate study of a Blue Waxbill perched on a branch. This small finch native to sub-Saharan Africa is captured in exquisite detail, showcasing its vibrant blue plumage contrasted against a warm golden background. The painting highlights the bird's distinctive features including its red bill and subtle color transitions.",
    year: "2023",
    ...
    additionalImages: ["/images/blue-waxbill.jpeg"],
    details:
