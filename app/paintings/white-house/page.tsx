...
export default function WhiteHousePage() {
  ...
  const painting = {
    ...
    description:
      "A moody, atmospheric landscape depicting a solitary white cottage with stone outbuildings perched on the edge of a dark, turbulent sea. The painting is rendered in a dramatic monochromatic palette of blacks, whites, and grays, creating a powerful sense of isolation and resilience against the elements. Storm clouds gather in the sky above, while waves break against the shore, suggesting the constant dialogue between human habitation and the raw power of nature. The stark white of the house creates a compelling focal point against the somber surroundings.",
    year: "2023",
