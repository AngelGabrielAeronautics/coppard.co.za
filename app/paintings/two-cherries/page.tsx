...
export default function TwoCherriesPage() {
  ...
  const painting = {
    ...
    title: "Two Cherries",
    description:
      "A vibrant still life of two cherries with connected stems against a rich blue background. This painting celebrates the simple beauty of these fruits, capturing their glossy surface and deep red color. The composition creates a sense of balance and harmony, while the blue background enhances the warmth of the cherries.",
    year: "2023",
    ...
    additionalImages: ["/images/two-cherries.jpeg"],
    details:
