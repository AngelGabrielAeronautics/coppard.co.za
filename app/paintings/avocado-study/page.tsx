...
export default function AvocadoStudyPage() {
  ...
  const painting = {
    ...
    title: "Avocado Study",
    description:
      "A detailed still life study of a halved avocado, showcasing the rich green flesh and brown pit against a warm textured background. This painting captures the simple beauty of everyday objects, with careful attention to light, shadow, and texture. The composition draws the viewer's eye to the central subject, creating a meditative focus on this humble fruit.",
    year: "2023",
    ...
    additionalImages: ["/images/still-life-avocado.jpeg"],
    details:
