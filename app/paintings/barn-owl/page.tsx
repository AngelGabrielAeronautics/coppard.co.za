...
export default function BarnOwlPage() {
  ...
  const painting = {
    ...
    title: "Who",
    description:
      "A striking close-up portrait of a barn owl, capturing the bird's distinctive heart-shaped facial disc and penetrating dark eyes against a rich, dark background. The painting showcases the owl's remarkable features in exquisite detail—the delicate texture of its white and gold feathers, the subtle variations in coloration, and the intensity of its gaze. The contrast between the owl's pale plumage and the dark surroundings creates a dramatic effect, drawing the viewer into the mysterious world of this nocturnal hunter.",
    year: "2023",
