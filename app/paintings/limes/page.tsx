...
export default function LimesPage() {
  ...
  const painting = {
    ...
    description:
      "A rich still life composition featuring fresh limes arranged in a woven basket against a deep, dark background. Some limes are whole while others are cut in half, revealing their juicy interior. The painting captures the vibrant green color and glossy texture of the limes, with careful attention to light reflections and shadows. The contrast between the bright fruit and the dark background creates a dramatic, classical still life effect.",
    year: "2023",
    ...
    additionalImages: ["/images/limes.jpeg"],
    details:
