...
export default function RobertFordPage() {
  ...
  const painting = {
    ...
    title: "Robert Ford",
    description:
      "A haunting portrait of a figure in Victorian-era attire, standing solemnly against a misty, atmospheric landscape. The subject, dressed in a long black coat and top hat with arms crossed, appears contemplative and mysterious. The painting employs a limited palette of muted tones with warm earth colors at the bottom transitioning to pale, ethereal skies, creating a dreamlike quality that evokes both historical narrative and emotional depth.",
    year: "2023",
    ...
    additionalImages: ["/images/robert-ford.jpeg"],
    details:
