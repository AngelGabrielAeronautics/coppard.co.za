...
export default function NaartjiesPage() {
  ...
  const painting = {
    ...
    description:
      "An elegant still life featuring bright orange naartjies (clementines/mandarins) arranged in a gleaming silver compote bowl, with one fruit placed on the rich wooden surface beside it. Set against a deep black background, the painting captures the warm glow of the fruit contrasted with the cool reflective quality of the silver bowl. The composition balances classical still life traditions with contemporary sensibilities, highlighting the simple beauty of these citrus fruits.",
    year: "2023",
    ...
    additionalImages: ["/images/naartjies.jpeg"],
    details:
