...
export default function OneCherryPage() {
  ...
  const painting = {
    ...
    title: "One Cherry",
    description:
      "A minimalist study of a single cherry with its stem, set against a soft gray background. This painting captures the simple elegance of this small fruit, with careful attention to the glossy surface and subtle reflections. The composition draws the viewer's eye to the cherry's perfect form and rich color.",
    year: "2023",
    ...
    additionalImages: ["/images/one-cherry.jpeg"],
    details:
